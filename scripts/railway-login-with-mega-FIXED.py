...
async def sign_in_to_railway(page, email: str, inbox_page, email_timeout_ms: int, profile_dir: Path) -> None:
...
async def run(profile_dir: Path, email_timeout_ms: int, railway_dir: Path) -> None:
    ...
    async with async_playwright() as playwright:
        ...
        try:
            ...
            await sign_in_to_railway(dashboard_page, email, inbox_page, email_timeout_ms, profile_dir)
