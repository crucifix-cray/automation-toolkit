...
## Mapping
Lovable N (2..51) → Railway cells `avail[:50]` = session-13,16,23,25,26,28,30,31,32,35,
...
**session-130 left out** (51st, no service). 123/124/127/128 restricted, 5 has no service.
